...
export class Medico extends Pessoa {
  ...
  constructor() {
    ...
    this.convenios = new Array<Convenio>(); this.foto = '../../assets/images/fotoCadastro.jpg', this.tempoRenovarSessao = 12, this.especialidade = new Especialidade(); this.especialidadeId = "";
