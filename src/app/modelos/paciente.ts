...
export class Paciente extends Pessoa {
  ...
  constructor() {
    ...
    this.numeroCartao = 1; this.cartaoNacionalSaude = 1; this.fotoId = ""; this.dataValidadeCartao = new Date('01/01/1901'); this.tipoPlano = ""; this.diaGestacao = ''; this.semanaGestacao = ''
  }
