...
export const CadastrosRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'cadastroprontuario',
        component: CadastroProntuarioComponent,
        data: {
          title: 'Cadastro Prontuário Paciente',
          urls: [
            { title: 'Cadastro Prontuário Paciente', url: '/cadastros/cadastrar' }
          ]
        }
      },
      {
